						...
						<li>
							...
							<div class="grid-container pt-4 pb-1 pb-lg-3 px-0 px-lg-5">
								...
								<div class="grid-item">
									...
									<img src="<?php echo $servidor . $value["img_peq"]; ?>" class="img-fluid" width="100%">

								</div>

								<div class="grid-item">

									<h1 class="mt-4 mb-0 my-lg-2">
								...
								<div class="grid-item d-none d-lg-block">
									...
									<img src="<?php echo $servidor . $value["img_gran"]; ?>" class="img-fluid" width="100%">
